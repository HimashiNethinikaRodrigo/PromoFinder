...
final public class SharedPrefsUtil {
    ...
    /**
     * put bulk of preferences
     * @param context
     * @param values
     * @return
     */
    public static boolean setMapAsStringPreferences(Context context, Map<String, String> values){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences != null) {
            SharedPreferences.Editor editor = preferences.edit();
    ...
    /**
     * remove bulk of preferences
     * @param context
     * @param keys
     */
    public static void removePreferenceList(Context context, String ... keys){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences != null) {
            SharedPreferences.Editor editor = preferences.edit();
            for (String key : keys) {
